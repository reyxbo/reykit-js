            ...
            <div className='flex justify-between items-center p-2 z-10 gap-2'>
                ...
                <div className='flex items-center rounded-md border bg-muted/50 overflow-hidden'>
                    <Button
                        ...
                        title={{ 'en': 'Expand All', 'zh': '展开全部' }[language]}
                    >
                        <icon.ChevronsUpDown />
                    </Button>
                    ...
                    <Button
                        ...
                        onClick={collapseAll}
                        className='h-7 px-2 text-xs hover:bg-muted rounded-none'
                        title={{ 'en': 'Collapse All', 'zh': '折叠全部' }[language]}
                    >
                        <icon.ChevronsDownUp />
                    </Button>
                    <Separator orientation='vertical' className='h-4' />
                            ...
                            return (
                                <div
                                    ...
                                    className={cn(
                                        'group rounded-md',
                                        !isChildCollapsible &&
                                        'flex items-start min-h-4 md:min-h-6 h-auto',
                                        isChildOpen ? '' : 'hover:bg-muted-foreground/20'
                                    )}
                                >
                                    <JsonNode
            ...
            <TooltipTrigger
                render={
                    ...
                    >
                        ...
                        {hasCopied ? <icon.Check /> : <icon.Copy />}
                    </Button>
                }
            />
            <TooltipContent>
                {
                    hasCopied
                    ? { 'en': 'Copied', 'zh': '已复制' }[language]
                    : { 'en': 'Copy to Clipboard', 'zh': '复制到剪贴板' }[language]
                }
            </TooltipContent>
        </Tooltip>
    )
